...
Detect context-change points (subgoals) in trajectories by analyzing world model prediction errors, enabling extraction of abstract transitions for high-level planning.
