...
Provide a goal-conditioned planner that takes a current frame and a goal frame, encodes both into latent space, and uses CEM optimization over latent rollouts to produce action sequences that drive the agent toward the goal.
