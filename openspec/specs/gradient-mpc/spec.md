...
Provide gradient-based action refinement for the latent planner, enabling differentiable rollouts through the world model and gradient descent on action sequences to minimize latent-space distance to goals.
