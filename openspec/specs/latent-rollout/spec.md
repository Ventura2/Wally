...
Provide a latent-space rollout module that applies a frozen world model's Transformer predictor over multiple timesteps to predict latent trajectories, enabling planning in latent space without pixel-space decoding.
